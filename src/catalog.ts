...
export interface Sheet { id: string; name: string; file: string; description?: string; credit?: string; creditLink?: string; portraitMischen?: "multiply"; layout?: "setting" | "formular" }
